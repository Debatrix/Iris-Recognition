...
#   Parameters
#------------------------------------------------------------------------------
CASIA1_DIR = "E:\Lwork\Iris-Recognition\CASIA1"
N_IMAGES = 4
...
if __name__ == "__main__":
    ...
    identities = glob(os.path.join(CASIA1_DIR, "*", "*_1_*.jpg"))
    ...
    for identity in identities:
        files = glob(os.path.join(CASIA1_DIR, "*", "*_2_*.jpg"))
        shuffle(files)
    ...
    best_results = []
    for eye_threshold in tqdm(eyelashes_thresholds, total=len(eyelashes_thresholds), ncols=60):
        # Extract features
